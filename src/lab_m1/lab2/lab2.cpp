...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.583f,  0.771f,  0.014f)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.609f,  0.115f,  0.436f)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0.327f,  0.483f,  0.844f)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.822f,  0.569f,  0.201f)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.435f,  0.602f,  0.223f)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.310f,  0.747f,  0.185f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.597f,  0.770f,  0.761f)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.559f,  0.436f,  0.730f)),
    ...
    // by definition!
    {
        ...
        CreateMesh("tetraedru", vertices1, indices1);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-1.7f, 0.8f, 1), glm::vec3(0.25f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(-2.3f, 1.3f, 1.3), glm::vec3(0.25f));
    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-2.7f, 1.9f, 1.8), glm::vec3(0.25f));
